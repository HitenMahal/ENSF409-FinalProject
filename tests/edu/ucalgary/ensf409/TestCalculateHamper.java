...
public class TestCalculateHamper {
    ...
    public void testCalculateHamper() throws InsufficientFoodException{
        ...
        FoodItem[] expected = new FoodItem[]{ foods[0], foods[1], foods[2], foods[5]};
    ...
    public void testCalculateNutritionWaste() {
        ...
        // As shown in the test above, this hamper has exactly what the client will need except for one extra item ( Tuna foods[6] )
    ...
    public void testCalculateHamperNutrition() {
        ...
        // The nutrition of the hamper will be exactly {400, 700, 650, 750, 2500} note that is also the exact client needs
        Hamper testHamper = new Hamper( 
